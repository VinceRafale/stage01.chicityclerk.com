<?php
   ...
   header( 'Location: http://stage01.chicityclerk.com/city-stickers-parking/pricing/' ) ;
								...
								<ul id="menu-city-stickers-parking" class="menu">
									...
									<li class="current-menu-parent">
										...
										<ul class="sub-menu nav">
											<li>
												<a href="/city-stickers-parking/about-city-vehicle-stickers/find-vin/">&raquo; What's a VIN?</a>
											</li>
											<li>
												<a href="/city-stickers-parking/about-city-vehicle-stickers/vin/">&raquo; Renewal Form Errors</a>
											</li>
											<li>
											...
											<p>The price of a City Vehicle Sticker depends on the following factors: </p>
												...
												<table id="datatable" class="table table-bordered table-striped table-condensed">
													...
													<tbody>
														...
														<tr>
															<td class="hide"><?php echo $pricing->mid; ?></td>
