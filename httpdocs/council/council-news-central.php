					...
					<table style="width: 100%;">
						<tbody>
							<tr>
								...
								<td style="width: 20%; padding: 5px;"><a class="btn btn-danger btn-block btn-large" href="http://chicago.legistar.com/MeetingDetail.aspx?ID=211035&GUID=43AED644-A324-4DBB-BCEC-9A7C0762E4F8&Options=info|&Search=" target="_blank">Meeting Agenda</a></td>
								<td style="width: 20%; padding: 5px;"><a class="btn btn-warning btn-block btn-large" href="/legislation-records/journals-reports/city-budgets/" target="_blank">2013 City Budget</a></td>
