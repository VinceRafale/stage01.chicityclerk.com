...
<div id="content" class="container">
	<div class="row">
		...
		<div class="span3home" id="left-column">
			<div id="announcements">
				...
				<div class="announcement" id="announcement-council">
					...
					<p>Wednesday, June 26, 2013<br />Time: 10:00a.m.<br />Location: City Hall</p>
					<div id="calendar-select" class="modal hide fade in" style="display: none;">
						...
						<div class="modal-body">
							<table style="width: 100%;">
								<tbody>
									<tr>
										<td><a class="btn btn-primary btn-block" href="https://www.google.com/calendar/event?action=TEMPLATE&tmeid=ZjIwaDdkOWtiMjlncnBxMmNsOG1sYzk2NzQgY2hpY2Fnb2NpdHljbGVya0Bt&tmsrc=chicagocityclerk%40gmail.com" target="_blank">Add to Google Calendar</a></td>
										<td><a class="btn btn-primary btn-block" href="webcal://stage01.chicityclerk.com/city-council.ics" target="_blank">Add to Outlook Calendar</a></td>
									</tr>
								</tbody>
							</table>
						</div>
		...
		<div class="span9home homeborder" id="right-column">
			...
			<div id="cnc-ad">
				<a class="cnc-ad-link" href="http://chicago.legistar.com/MeetingDetail.aspx?ID=245149&GUID=525ABAEF-DC15-485F-84FD-B585E846F2E2&Options=info|&Search=">
