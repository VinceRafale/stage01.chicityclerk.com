...
<body <?php body_class(); ?>>
<div id="header">
	<h1>City of Chicago Office of the City Clerk</h1>
</div>
<div class="nav">
	...
	<nav class="top-bar">
	    <ul class="title-area">
	        <li class="name">
	        	<h1><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">ChiCityClerk</a></h1>
	        </li>
